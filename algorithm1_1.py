...
# --- Valid samples only ---
valid_samples = [i for i, models in sample_to_excluded_models.items() if len(models) >= 1]
print("valid samples")
print(valid_samples)
valid_samples.sort()
...
if __name__ == "__main__":
    ...
    with open(f"memorization_scores_chrf_{task_id}_excl1.json", "w") as f:
